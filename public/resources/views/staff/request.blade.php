          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
                 <table class="table dt1">
                    <thead>
                      <tr>
                        <th>User</th><th>Photo</th><th>Type</th><th>Year</th><th>Purpose</th><th>Status</th><th></th>
                      </tr>
                    </thead>
                    <tbody>
                      @foreach ($clearance as $c)
                        ...
                        <tr <?php echo 'class="'.$color.'"' ?> >
                          ...
                          <td>
                           <a class="btn btn-md btn-info" onclick="viewclearanceStaffDetails({{$c->id}})">More details</a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if ($c->approval_status == 'approved')
                        <a class="btn btn-md btn-danger" href="{{URL('staff/businesspermit/approval/'.$c->id.'/reject') }}">Reject</a>
                    @elseif($c->approval_status == 'reject')
                        <a class="btn btn-md btn-success" href="{{URL('staff/businesspermit/approval/'.$c->id.'/approved') }}">Approve</a>
                    @else
                         <a class="btn btn-md btn-danger" href="{{URL('staff/businesspermit/approval/'.$c->id.'/reject') }}">Reject</a>
                            <a class="btn btn-md btn-success" href="{{URL('staff/businesspermit/approval/'.$c->id.'/approved') }}">Approve</a>
                    @endif
                ...
                <tr>
                  ...
                  <td>
                    @if ($c->status == 'approved')
                        <a class="btn btn-md btn-danger" href="{{URL('staff/certification/approval/'.$c->id.'/reject') }}">Reject</a>
                    @elseif($c->status == 'reject')
                        <a class="btn btn-md btn-success" href="{{URL('staff/certification/approval/'.$c->id.'/approved') }}">Approve</a>
                    @else
                         <a class="btn btn-md btn-danger" href="{{URL('staff/certification/approval/'.$c->id.'/reject') }}">Reject</a>
                            <a class="btn btn-md btn-success" href="{{URL('staff/certification/approval/'.$c->id.'/approved') }}">Approve</a>
                    @endif
            ...
            <tbody>
              @foreach ($certification as $c)
                <tr>
                  ...
                  <td>
                    @if ($c->approval_status == 'approved')
                        <a class="btn btn-md btn-danger" href="{{URL('staff/socialpension/approval/'.$c->id.'/reject') }}">Reject</a>
                    @elseif($c->approval_status == 'reject')
                        <a class="btn btn-md btn-success" href="{{URL('staff/socialpension/approval/'.$c->id.'/approved') }}">Approve</a>
                    @else
                         <a class="btn btn-md btn-danger" href="{{URL('staff/socialpension/approval/'.$c->id.'/reject') }}">Reject</a>
                            <a class="btn btn-md btn-success" href="{{URL('staff/socialpension/approval/'.$c->id.'/approved') }}">Approve</a>
                    @endif
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div id="data-clearance-detail-staff"></div>
        </div>
